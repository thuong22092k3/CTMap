import 'package:ctmap/data/law.dart';

List<Chapter> lawData = [
  Chapter(
    title: 'Chương I\nNHỮNG QUY ĐỊNH CHUNG',
    articles: [
      Article(
        title: 'Điều 1. Phạm vi điều chỉnh',
        content: 'Luật này quy định về quy tắc, phương tiện, người tham gia giao thông đường bộ, '
                 'chỉ huy, điều khiển, tuần tra, kiểm soát, giải quyết tai nạn giao thông đường bộ, '
                 'trách nhiệm quản lý nhà nước và trách nhiệm của cơ quan, tổ chức, cá nhân có liên quan '
                 'đến trật tự, an toàn giao thông đường bộ.',
      ),
      Article(
        title: 'Điều 2. Giải thích từ ngữ',
        content: "1. Trật tự, an toàn giao thông đường bộ là trạng thái giao thông trên đường bộ có trật tự, "
                 "bảo đảm an toàn, thông suốt; được hình thành và điều chỉnh bởi các quy tắc, nguyên tắc, "
                 "quy phạm pháp luật trong lĩnh vực giao thông đường bộ.\n\n"
                 "2. Phương tiện giao thông đường bộ là các loại xe, bao gồm: phương tiện giao thông cơ giới "
                 "đường bộ (sau đây gọi là xe cơ giới), phương tiện giao thông thô sơ đường bộ (sau đây "
                 "gọi là xe thô sơ), xe máy chuyên dùng và các loại xe tương tự.\n\n"
                 "3. Phương tiện tham gia giao thông đường bộ là phương tiện giao thông đường bộ tham gia "
                 "giao thông trên đường bộ.\n\n"
                 "4. Đường ưu tiên là đường mà trên đó phương tiện tham gia giao thông đường bộ được các "
                 "phương tiện tham gia giao thông đường bộ đến từ hướng khác nhường đường khi qua nơi "
                 "đường giao nhau, được cắm biển báo hiệu đường ưu tiên.\n\n"
                 "5. Phần đường xe chạy là phần của đường bộ được sử dụng cho phương tiện giao thông đường "
                 "bộ đi lại.\n\n"
                 "6. Làn đường là một phần của phần đường xe chạy được chia theo chiều dọc của đường, có đủ "
                 "chiều rộng cho xe chạy an toàn.\n\n"
                 "7. Cải tạo xe (sau đây gọi là cải tạo) là việc thay đổi đặc điểm của xe đã được cấp đăng "
                 "ký xe, biển số xe hoặc xe đã qua sử dụng được nhập khẩu dẫn đến thay đổi về kiểu loại "
                 "xe theo quy định của cơ quan có thẩm quyền.\n\n"
                 "8. Người tham gia giao thông đường bộ bao gồm: người điều khiển, người được chở trên "
                 "phương tiện tham gia giao thông đường bộ; người điều khiển, dẫn dắt vật nuôi trên đường "
                 "bộ; người đi bộ trên đường bộ.\n\n"
                 "9. Người điều khiển phương tiện tham gia giao thông đường bộ bao gồm: người điều khiển xe "
                 "cơ giới (sau đây gọi là người lái xe), người điều khiển xe thô sơ, người điều khiển xe "
                 "máy chuyên dùng.\n\n"
                 "10. Người điều khiển giao thông đường bộ (sau đây gọi là người điều khiển giao thông) "
                 "bao gồm: Cảnh sát giao thông và người được giao nhiệm vụ hướng dẫn giao thông trên đường "
                 "bộ.\n\n"
                 ...
                 "12. Tai nạn giao thông đường bộ là va chạm liên quan đến người, phương tiện khi tham gia "
                 "giao thông đường bộ, xảy ra ngoài ý muốn của người tham gia giao thông đường bộ, gây thiệt "
                 "hại đến tính mạng, sức khỏe, tài sản của cá nhân hoặc tài sản của cơ quan, tổ chức.\n\n"
                 "13. Thiết bị an toàn cho trẻ em là thiết bị có đủ khả năng bảo đảm an toàn cho trẻ em ở "
                 "tư thế ngồi hoặc nằm trên xe ô tô, được thiết kế để giảm nguy cơ chấn thương cho người "
                 "dùng trong trường hợp xảy ra va chạm hoặc xe ô tô giảm tốc độ đột ngột, bằng cách hạn chế "
                 "sự di chuyển của cơ thể trẻ em.\n\n"
                 "14. Thiết bị thông minh hỗ trợ chỉ huy, điều khiển giao thông đường bộ là thiết bị kỹ "
                 "thuật công nghệ có khả năng phát hiện, phân tích, đánh giá các tình huống giao thông đường "
                 "bộ, vi phạm pháp luật trên đường bộ; do lực lượng chức năng sử dụng để hỗ trợ chỉ huy, "
                 "điều khiển giao thông đường bộ, giải quyết tình huống và xử lý vi phạm pháp luật trên "
                 "đường bộ.",
      ),
      Article(
        title: 'Điều 3. Nguyên tắc bảo đảm trật tự, an toàn giao thông đường bộ',
        content: '1. Tuân thủ Hiến pháp, pháp luật Việt Nam và điều ước quốc tế mà nước Cộng hòa xã hội chủ nghĩa Việt Nam là thành viên.\n\n'
                '2. Bảo đảm giao thông đường bộ được trật tự, an toàn, thông suốt, góp phần phát triển kinh tế - xã hội, '
                'bảo đảm quốc phòng, an ninh và bảo vệ môi trường; phòng ngừa vi phạm pháp luật về trật tự, an toàn '
                'giao thông đường bộ, tai nạn giao thông đường bộ và ùn tắc giao thông; bảo vệ tính mạng, sức khỏe, '
                ...
                '4. Người tham gia giao thông đường bộ phải chấp hành các quy định của pháp luật về trật tự, an toàn '
                'giao thông đường bộ và quy định khác của pháp luật có liên quan, có trách nhiệm giữ an toàn cho mình '
                'và cho người khác.\n\n'
                '5. Mọi hành vi vi phạm pháp luật về trật tự, an toàn giao thông đường bộ phải được phát hiện, '
                'ngăn chặn kịp thời và phải bị xử lý nghiêm minh theo quy định của pháp luật.\n\n'
                '6. Hoạt động bảo đảm trật tự, an toàn giao thông đường bộ phải công khai, minh bạch và thuận lợi cho '
                'người dân.\n\n'
                '7. Công tác bảo đảm trật tự, an toàn giao thông đường bộ được thực hiện thống nhất trên cơ sở phân công, '
                'phân cấp, phù hợp với chức năng, nhiệm vụ và sự phối hợp chặt chẽ giữa các cơ quan, tổ chức, cá nhân '
                'có liên quan.',
      ),
      Article(
        title: 'Điều 4. Chính sách của Nhà nước về trật tự, an toàn giao thông đường bộ',
        content: '1. Bảo đảm ngân sách nhà nước, cơ sở vật chất, phương tiện, thiết bị hiện đại, các điều kiện bảo đảm '
                'và nâng cao năng lực thực thi nhiệm vụ của lực lượng trực tiếp bảo đảm trật tự, an toàn giao thông '
                'đường bộ. Huy động, sử dụng các nguồn lực để bảo đảm trật tự, an toàn giao thông đường bộ. Bố trí '
                'tương ứng từ các khoản thu tiền xử phạt vi phạm hành chính về trật tự, an toàn giao thông đường bộ '
                'và tiền đấu giá biển số xe sau khi nộp vào ngân sách nhà nước để tăng cường, hiện đại hóa cơ sở '
                'vật chất, phương tiện, thiết bị, phục vụ bảo đảm an ninh, trật tự, an toàn giao thông theo quy định '
                'của Chính phủ.\n\n'
                '2. Hiện đại hóa các trung tâm chỉ huy giao thông; bảo đảm kết nối, chia sẻ Cơ sở dữ liệu về trật tự, '
                'an toàn giao thông đường bộ giữa các cơ quan nhà nước có liên quan.\n\n'
                '3. Tạo điều kiện để cơ quan, tổ chức, cá nhân trong nước, nước ngoài nghiên cứu, ứng dụng và chuyển '
                'giao khoa học, công nghệ trong công tác bảo đảm trật tự, an toàn giao thông đường bộ, đầu tư, '
                'xây dựng, chuyển giao hệ thống, phương tiện, thiết bị giám sát phục vụ công tác bảo đảm trật tự, '
                ...
                '4. Bảo đảm công bằng, bình đẳng, an toàn đối với người tham gia giao thông đường bộ; tạo thuận lợi '
                'cho trẻ em, phụ nữ mang thai, người già yếu, người khuyết tật trong tham gia giao thông đường bộ; '
                'xây dựng văn hóa giao thông; giáo dục, phổ biến, bồi dưỡng kiến thức pháp luật về giao thông đường '
                'bộ cho trẻ em, học sinh để hình thành, nâng cao ý thức tự bảo vệ bản thân và tự giác chấp hành '
                'pháp luật khi tham gia giao thông đường bộ.\n\n'
                '5. Cơ quan, tổ chức, cá nhân tham gia phối hợp, cộng tác, hỗ trợ, giúp đỡ cơ quan nhà nước thực hiện '
                'nhiệm vụ bảo đảm trật tự, an toàn giao thông đường bộ, có thành tích thì được khen thưởng, bị thiệt '
                'hại về tài sản thì được đền bù; người bị tổn hại về danh dự, nhân phẩm thì được khôi phục; người '
                'bị thương, bị tổn hại về sức khỏe, tính mạng thì bản thân, gia đình được hưởng chế độ, chính sách '
                ...
                'giao thông đường bộ bảo đảm chất lượng an toàn kỹ thuật và bảo vệ môi trường, phù hợp với xu hướng '
                'phát triển công nghệ đối với phương tiện giao thông trên thế giới; ưu tiên phát triển phương tiện '
                'vận tải công cộng, hạn chế sử dụng phương tiện giao thông cá nhân tham gia giao thông tại các đô thị '
                'lớn; ưu tiên chuyển đổi phương tiện sử dụng nhiên liệu hóa thạch sang phương tiện sử dụng điện, '
                'năng lượng xanh, thân thiện môi trường, hạ tầng cung cấp năng lượng sạch.',
      ),
      Article(
        title: 'Điều 5. Tuyên truyền, phổ biến pháp luật về trật tự, an toàn giao thông đường bộ',
        content: '1. Tuyên truyền, phổ biến pháp luật về trật tự, an toàn giao thông đường bộ được thực hiện thường '
                ...
                'cơ quan hữu quan và chính quyền địa phương tuyên truyền, vận động Nhân dân thực hiện pháp luật về '
                'trật tự, an toàn giao thông đường bộ.\n\n'
                '5. Bộ, cơ quan ngang Bộ, Ủy ban nhân dân các cấp, trong phạm vi nhiệm vụ, quyền hạn của mình, có '
                'trách nhiệm tổ chức tuyên truyền, phổ biến pháp luật về trật tự, an toàn giao thông đường bộ, có '
                ...
                'tuyên truyền, phổ biến pháp luật về trật tự, an toàn giao thông đường bộ cho đối tượng thuộc '
                'thẩm quyền quản lý.\n\n'
                '7. Thành viên trong gia đình có trách nhiệm tuyên truyền, nhắc nhở thành viên khác chấp hành pháp '
                'luật về trật tự, an toàn giao thông đường bộ, sử dụng dây đai an toàn, mũ bảo hiểm, không uống rượu, '
                'bia khi tham gia giao thông đường bộ.',
      ),
      Article(
        title: 'Điều 6. Hệ thống văn bản quy phạm pháp luật về trật tự, an toàn giao thông đường bộ',
        content: '1. Hệ thống văn bản quy phạm pháp luật về trật tự, an toàn giao thông đường bộ gồm:\n\n'
                'a) Luật này;\n\n'
                'b) Các văn bản quy phạm pháp luật của Quốc hội, Ủy ban Thường vụ Quốc hội, Chính phủ, Bộ, cơ quan '
                'ngang Bộ, Ủy ban nhân dân các cấp và văn bản quy phạm pháp luật khác có liên quan đến trật tự, '
                'an toàn giao thông đường bộ.\n\n'
                '2. Trường hợp văn bản quy phạm pháp luật có quy định khác với quy định của Luật này thì áp dụng '
                'theo quy định của Luật này.',
      ),
      Article(
        title: 'Điều 7. Trách nhiệm của tổ chức, cá nhân trong việc bảo đảm trật tự, an toàn giao thông đường bộ',
        content: '1. Tổ chức, cá nhân có trách nhiệm bảo đảm trật tự, an toàn giao thông đường bộ phải thực hiện '
                'đầy đủ các nghĩa vụ, quyền hạn quy định tại Luật này và các quy định pháp luật có liên quan.\n\n'
                '2. Tổ chức, cá nhân thực hiện nghĩa vụ bảo đảm trật tự, an toàn giao thông đường bộ không được cản trở '
                'hoạt động bình thường của giao thông đường bộ.\n\n'
                '3. Tổ chức, cá nhân được Nhà nước giao nhiệm vụ bảo đảm trật tự, an toàn giao thông đường bộ phải '
                'thực hiện các nghĩa vụ sau đây:\n\n'
                'a) Chịu trách nhiệm trước pháp luật về việc thực hiện các nghĩa vụ, quyền hạn của mình;\n\n'
                'b) Có trách nhiệm phối hợp với các cơ quan, tổ chức, cá nhân có liên quan trong việc bảo đảm '
                'trật tự, an toàn giao thông đường bộ;\n\n'
                'c) Thực hiện đầy đủ nghĩa vụ tài chính theo quy định của pháp luật;\n\n'
                'd) Bảo đảm nguồn lực, trang thiết bị, phương tiện để thực hiện nhiệm vụ bảo đảm trật tự, an toàn '
                'giao thông đường bộ;\n\n'
                'đ) Thực hiện các biện pháp, hình thức bảo đảm trật tự, an toàn giao thông đường bộ theo quy định '
                'của pháp luật;\n\n'
                'e) Thực hiện báo cáo định kỳ hoặc đột xuất về tình hình bảo đảm trật tự, an toàn giao thông đường '
                'bộ theo yêu cầu của cơ quan nhà nước có thẩm quyền.',
      ),
      Article(
        title: 'Điều 8. Đánh giá, thống kê về tình hình trật tự, an toàn giao thông đường bộ',
        content: '''1. Đánh giá, thống kê về tình hình trật tự, an toàn giao thông đường bộ được thực hiện thường xuyên nhằm theo dõi, tổng hợp, phân tích và dự báo tình hình tai nạn giao thông đường bộ, ùn tắc giao thông và đề ra các giải pháp bảo đảm trật tự, an toàn giao thông đường bộ.
        2. Đánh giá, thống kê về tình hình trật tự, an toàn giao thông đường bộ phải được thực hiện trên cơ sở dữ liệu quốc gia về trật tự, an toàn giao thông đường bộ do cơ quan nhà nước có thẩm quyền quản lý và phải bảo đảm tính chính xác, khách quan, trung thực, kịp thời và đầy đủ.
        3. Cơ quan nhà nước có thẩm quyền tổ chức thực hiện việc đánh giá, thống kê tình hình trật tự, an toàn giao thông đường bộ phải công bố công khai kết quả đánh giá, thống kê và đưa ra giải pháp khắc phục, phòng ngừa.'''
      ),
      Article(
        title: 'Điều 9. Thẩm quyền và trách nhiệm của cơ quan nhà nước trong việc bảo đảm trật tự, an toàn giao thông đường bộ',
        content: '1. Chính phủ thống nhất quản lý nhà nước về trật tự, an toàn giao thông đường bộ; tổ chức chỉ '
                'đạo, điều hành công tác bảo đảm trật tự, an toàn giao thông đường bộ.\n'
                '2. Bộ Giao thông vận tải chịu trách nhiệm trước Chính phủ về việc thực hiện các nhiệm vụ quản lý '
                'nhà nước về trật tự, an toàn giao thông đường bộ.\n'
                '3. Các bộ, cơ quan ngang Bộ có trách nhiệm trong phạm vi chức năng, nhiệm vụ của mình, phối hợp với '
                'Bộ Giao thông vận tải trong việc tổ chức thực hiện và kiểm tra việc thực hiện pháp luật về trật '
                'tự, an toàn giao thông đường bộ.\n'
                '4. Ủy ban nhân dân các cấp thực hiện quản lý nhà nước về trật tự, an toàn giao thông đường bộ tại '
                'địa phương; có trách nhiệm tổ chức triển khai thực hiện pháp luật về trật tự, an toàn giao thông '
  ...
  Chapter(
    ...
    articles: [
      Article(
        title: 'Điều 10. Quy tắc chung', 
        content: '''1. Người tham gia giao thông đường bộ phải đi bên phải theo chiều đi của mình, đi đúng làn đường, phần đường quy định, chấp hành báo hiệu đường bộ và các quy tắc giao thông đường bộ khác.
...
3. Khi chở trẻ em dưới 10 tuổi và chiều cao dưới 1,35 mét trên xe ô tô không được cho trẻ em ngồi cùng hàng ghế với người lái xe, trừ loại xe ô tô chỉ có một hàng ghế; người lái xe phải sử dụng, hướng dẫn sử dụng thiết bị an toàn phù hợp cho trẻ em.'''
      ...
      Article(
        title: 'Điều 11. Chấp hành báo hiệu đường bộ', 
        content: '''1. Báo hiệu đường bộ bao gồm: hiệu lệnh của người điều khiển giao thông; đèn tín hiệu giao thông; biển báo hiệu đường bộ; vạch kẻ đường và các dấu hiệu khác trên mặt đường; cọc tiêu, tường bảo vệ, rào chắn, đinh phản quang, tiêu phản quang, cột Km, cọc H; thiết bị âm thanh báo hiệu đường bộ.
...
14. Bộ trưởng Bộ Công an quy định chi tiết khoản 3 Điều này.'''
      ...
      Article(
        title: 'Điều 12. Chấp hành quy định về tốc độ và khoảng cách giữa các xe', 
        content: '''1. Người lái xe, người điều khiển xe máy chuyên dùng phải chấp hành quy định về tốc độ, khoảng cách an toàn tối thiểu với xe phía trước cùng làn đường hoặc phần đường.
...
4. Bộ trưởng Bộ Giao thông vận tải quy định chi tiết về tốc độ và khoảng cách an toàn của xe cơ giới, xe máy chuyên dùng tham gia giao thông đường bộ.'''
      ...
      Article(
        title: 'Điều 13. Sử dụng làn đường', 
        content: '''1. Phương tiện tham gia giao thông đường bộ di chuyển với tốc độ thấp hơn phải đi về bên phải theo chiều đi của mình.
...
4. Trên làn đường dành riêng cho một loại phương tiện hoặc một nhóm loại phương tiện, người điều khiển loại phương tiện khác không được đi vào làn đường đó.'''
      ...
      Article(
        title: 'Điều 14. Vượt xe và nhường đường cho xe xin vượt ', 
        content: '''1. Vượt xe là tình huống giao thông trên đường mà mỗi chiều đường xe chạy chỉ có một làn đường dành cho xe cơ giới, xe đi phía sau di chuyển sang bên trái để di chuyển lên trước xe phía trước.
...
k) Trong hầm đường bộ.'''
      ...
      Article(
        title: 'Điều 15. Chuyển hướng xe', 
        content: '''1. Chuyển hướng xe là tình huống giao thông mà xe rẽ trái hoặc rẽ phải hoặc quay đầu xe.
...
4. Không được quay đầu xe ở phần đường dành cho người đi bộ qua đường, trên cầu, đầu cầu, gầm cầu vượt, ngầm, tại nơi đường bộ giao nhau cùng mức với đường sắt, đường hẹp, đường dốc, đoạn đường cong tầm nhìn bị che khuất, trên đường cao tốc, trong hầm đường bộ, trên đường một chiều, trừ khi có hiệu lệnh của người điều khiển giao thông hoặc chỉ dẫn của biển báo hiệu tạm thời.'''
       ...
       Article(
        title: 'Điều 16. Lùi xe', 
        content: '''1. Khi lùi xe, người điều khiển phương tiện tham gia giao thông đường bộ phải quan sát hai bên và phía sau xe, có tín hiệu lùi và chỉ lùi xe khi bảo đảm an toàn.
...
2. Không được lùi xe ở đường một chiều, khu vực cấm dừng, trên phần đường dành cho người đi bộ qua đường, nơi đường bộ giao nhau, đường bộ giao nhau cùng mức với đường sắt, nơi tầm nhìn bị che khuất, trong hầm đường bộ, trên đường cao tốc.'''
       ...
       Article(
        title: 'Điều 17. Tránh xe đi ngược chiều', 
        content: '''1. Trên đường không phân chia thành hai chiều xe chạy riêng biệt, hai xe đi ngược chiều tránh nhau, người điều khiển phương tiện tham gia giao thông đường bộ phải giảm tốc độ và cho xe đi về bên phải theo chiều xe chạy của mình.
...
c) Xe có chướng ngại vật phía trước phải nhường đường cho xe không có chướng ngại vật phía trước.'''
       ...
       Article(
        title: 'Điều 18. Dừng xe, đỗ xe', 
        content: '''1. Dừng xe là trạng thái đứng yên tạm thời của xe trong một khoảng thời gian cần thiết đủ để cho người lên xe, xuống xe, xếp dỡ hàng hóa, kiểm tra kỹ thuật xe hoặc hoạt động khác. Khi dừng xe không được tắt máy và không được rời khỏi vị trí lái, trừ trường hợp rời khỏi vị trí lái để đóng, mở cửa xe, xếp dỡ hàng hóa, kiểm tra kỹ thuật xe nhưng phải sử dụng phanh đỗ xe hoặc thực hiện biện pháp an toàn khác.
...
7. Trong trường hợp gặp sự cố kỹ thuật hoặc bất khả kháng khác buộc phải đỗ xe, khi đỗ xe chiếm một phần đường xe chạy hoặc tại nơi không được phép đỗ, phải có báo hiệu bằng đèn khẩn cấp hoặc đặt biển cảnh báo về phía sau xe để người điều khiển phương tiện tham gia giao thông đường bộ khác biết.'''
       ...
       Article(
        title: 'Điều 19. Mở cửa xe', 
        content: '''1. Chỉ được mở cửa xe khi xe đã dừng, đỗ.
...
2. Trước khi mở cửa xe, người mở cửa phải quan sát phía trước, phía sau và bên phía mở cửa xe, khi thấy an toàn mới được mở cửa xe, ra khỏi xe; không để cửa xe mở nếu không bảo đảm an toàn.'''
       ...
       Article(
        title: 'Điều 20. Sử dụng đèn ', 
        content: '''1. Người lái xe, người điều khiển xe máy chuyên dùng tham gia giao thông đường bộ phải bật đèn chiếu sáng phía trước trong thời gian từ 18 giờ ngày hôm trước đến 06 giờ ngày hôm sau hoặc khi có sương mù, khói, bụi, trời mưa, thời tiết xấu làm hạn chế tầm nhìn.
...
3. Người lái xe, người điều khiển xe máy chuyên dùng khi thực hiện công việc trên đường bộ phải bật sáng đèn cảnh báo màu vàng.'''
       ...
       Article(
        title: 'Điều 21. Sử dụng tín hiệu còi ', 
        content: '''1. Chỉ được sử dụng tín hiệu còi của phương tiện tham gia giao thông đường bộ trong các trường hợp sau đây:
...
2. Không sử dụng còi liên tục; không sử dụng còi có âm lượng không đúng quy định; không sử dụng còi trong thời gian từ 22 giờ ngày hôm trước đến 05 giờ ngày hôm sau trong khu đông dân cư, khu vực cơ sở khám bệnh, chữa bệnh, trừ xe ưu tiên.'''
       ...
       Article(
        title: 'Điều 22. Nhường đường tại nơi đường giao nhau', 
        content: '''Khi đến gần đường giao nhau, người điều khiển phương tiện tham gia giao thông đường bộ phải quan sát, giảm tốc độ và nhường đường theo quy định sau đây:
...
3. Tại nơi đường giao nhau có báo hiệu đi theo vòng xuyến, phải nhường đường cho xe đi đến từ bên trái.'''
       ...
       Article(
        title: 'Điều 23. Qua phà, qua cầu phao', 
        content: '''1. Khi đến bến phà, cầu phao, các xe phải xếp hàng theo quy định, không làm cản trở giao thông.
...
c) Xe cơ giới, xe máy chuyên dùng, xe thô sơ, người đi bộ phải tuân thủ hướng dẫn của người điều khiển giao thông.'''
      ...
      Article(
        title: 'Điều 24. Giao thông tại đường ngang, cầu chung đường sắt', 
        content: '''1. Khi có hiệu lệnh của nhân viên gác chắn, đèn đỏ sáng nhấp nháy, chuông kêu, chắn đường bộ đang dịch chuyển hoặc đã đóng, người tham gia giao thông đường bộ phải dừng lại về bên phải đường của mình, trước vạch dừng xe.
...
3. Khi phương tiện tham gia giao thông đường bộ bị hư hỏng, bị tai nạn hoặc hàng hóa rơi đổ trên đường ngang, cầu chung đường sắt mà không thể di chuyển ngay khỏi phạm vi an toàn đường sắt, người điều khiển phương tiện tham gia giao thông đường bộ và người có mặt phải ngay lập tức báo hiệu để dừng tàu, thực hiện các biện pháp bảo đảm an toàn.'''
       ...
       Article(
        title: 'Điều 25. Giao thông trên đường cao tốc', 
        content: '''1. Người lái xe, người điều khiển xe máy chuyên dùng trên đường cao tốc phải tuân thủ quy tắc giao thông đường bộ sau đây:
...
3. Xe máy chuyên dùng có tốc độ thiết kế nhỏ hơn tốc độ tối thiểu quy định đối với đường cao tốc, xe chở người bốn bánh có gắn động cơ, xe chở hàng bốn bánh có gắn động cơ, xe mô tô, xe gắn máy, các loại xe tương tự xe mô tô, xe gắn máy, xe thô sơ, người đi bộ không được đi trên đường cao tốc, trừ người, phương tiện giao thông đường bộ và thiết bị phục vụ việc quản lý, bảo trì đường cao tốc.'''
       ...
       Article(
        title: 'Điều 26. Giao thông trong hầm đường bộ', 
        content: '''Người điều khiển phương tiện tham gia giao thông đường bộ khi điều khiển phương tiện trong hầm đường bộ phải tuân thủ quy tắc giao thông đường bộ sau đây:
...
7. Bộ trưởng Bộ Công an quy định các đoàn trong nước và khách nước ngoài đến Việt Nam có bố trí xe Cảnh sát giao thông dẫn đường; quy định quy trình dẫn đường của Cảnh sát giao thông đối với các đoàn trong nước và khách nước ngoài đến Việt Nam.'''
      ...
      Article(
        title: 'Điều 28. Trường hợp chở người trên xe ô tô chở hàng', 
        content: '''1. Chỉ được chở người trên thùng xe ô tô chở hàng trong trường hợp sau đây:
...
2. Xe ô tô chở hàng mà chở người trong các trường hợp quy định tại khoản 1 Điều này phải bảo đảm an toàn khi tham gia giao thông đường bộ.'''
      ...
      Article(
        title: 'Điều 29. Xe kéo xe, xe kéo rơ moóc và xe ô tô đầu kéo kéo sơ mi rơ moóc', 
        content: '''1. Một xe ô tô chỉ được kéo theo một xe ô tô hoặc xe máy chuyên dùng khác khi xe được kéo không tự chạy được, trừ trường hợp quy định tại khoản 3 Điều 53 của Luật này và phải bảo đảm các quy định sau đây:
...
3. Không được chở người trên xe được kéo, trừ người điều khiển; xe kéo rơ moóc, xe ô tô đầu kéo kéo sơ mi rơ moóc không được kéo thêm rơ moóc, sơ mi rơ moóc hoặc xe khác.'''
      ...
      Article(
        title: 'Điều 30. Người đi bộ; trẻ em, phụ nữ mang thai, người già yếu, người khuyết tật, người mất năng lực hành vi dân sự tham gia giao thông đường bộ', 
        content: '''1. Người đi bộ phải tuân thủ các quy định sau đây:
...
đ) Mọi người có trách nhiệm giúp đỡ trẻ em dưới 07 tuổi, phụ nữ mang thai, người già yếu, người khuyết tật, người mất năng lực hành vi dân sự khi đi qua đường.'''
      ...
      Article(
        title: 'Điều 31. Người điều khiển, người được chở, hàng hóa xếp trên xe thô sơ', 
        content: '''1. Người điều khiển xe đạp, xe đạp máy chỉ được chở một người, trừ trường hợp chở thêm một trẻ em dưới 07 tuổi thì được chở tối đa hai người.
...
3. Không được thả vật nuôi trên đường bộ.'''
      ...
      Article(
        title: 'Điều 33. Người lái xe, người được chở, hàng hóa xếp trên xe mô tô, xe gắn máy', 
        content: '''1. Người lái xe mô tô hai bánh, xe gắn máy chỉ được chở một người, trừ những trường hợp sau thì được chở tối đa hai người:
...
5. Xe mô tô, xe gắn máy không được xếp hàng hóa vượt quá chiều rộng giá đèo hàng về mỗi bên 0,3 mét, vượt quá về phía sau giá đèo hàng 0,5 mét theo thiết kế của nhà sản xuất; chiều cao xếp hàng hóa tính từ mặt đường xe chạy không vượt quá 02 mét.'''
  ...
  Chapter(
    ...
    articles: [
      Article(
        title: 'Điều 34. Phân loại phương tiện giao thông đường bộ', 
        content: '''1. Xe cơ giới bao gồm:
...
6. Bộ trưởng Bộ Giao thông vận tải quy định chi tiết Điều này; quy định dấu hiệu nhận biết xe cơ giới sử dụng năng lượng sạch, năng lượng xanh, thân thiện môi trường.'''
      ...
      Article(
        title: 'Điều 35. Điều kiện phương tiện tham gia giao thông đường bộ', 
        content: '''1. Xe cơ giới, xe máy chuyên dùng tham gia giao thông đường bộ phải đáp ứng các điều kiện sau đây:
...
6. Ủy ban nhân dân cấp tỉnh quy định phạm vi hoạt động của xe thô sơ, xe chở hàng bốn bánh có gắn động cơ, xe chở người bốn bánh có gắn động cơ tại địa phương.'''
      ...
      Article(
        title: 'Điều 36. Biển số xe', 
        content: '''1. Biển số xe do cơ quan nhà nước có thẩm quyền cấp theo quy định tại Điều 37 và Điều 39 của Luật này; được gắn vào phương tiện giao thông đường bộ theo quy định của Luật này để phục vụ quản lý nhà nước.
...
7. Chính phủ quy định chi tiết Điều này; quy định bước giá, hình thức, phương thức, trình tự, thủ tục đấu giá biển số xe.'''
      ...
      Article(
        title: 'Điều 38. Quyền và nghĩa vụ của người trúng đấu giá biển số xe', 
        content: '''1. Người trúng đấu giá biển số xe có quyền sau đây:
...
3. Chính phủ quy định chi tiết Điều này.'''
      ...
      Article(
        title: 'Điều 39. Cấp, thu hồi chứng nhận đăng ký xe và biển số xe cơ giới, xe máy chuyên dùng tham gia giao thông đường bộ', 
        content: '''1. Việc cấp mới chứng nhận đăng ký xe và biển số xe cơ giới, xe máy chuyên dùng phải bảo đảm các điều kiện sau đây:
...
8. Bộ trưởng Bộ Quốc phòng quy định trình tự, thủ tục cấp, thu hồi chứng nhận đăng ký xe, biển số xe cơ giới, xe máy chuyên dùng tham gia giao thông đường bộ do Bộ Quốc phòng quản lý.'''
      ...
      Article(
        title: 'Điều 40. Niên hạn sử dụng của xe cơ giới', 
        content: '''1. Niên hạn sử dụng của xe cơ giới được tính bắt đầu từ năm sản xuất xe đến hết ngày 31 tháng 12 của năm hết niên hạn sử dụng.
...
4. Chính phủ quy định chi tiết Điều này.'''
      ...
      Article(
        title: 'Điều 41. Bảo đảm chất lượng an toàn kỹ thuật và bảo vệ môi trường của xe cơ giới, xe máy chuyên dùng, phụ tùng xe cơ giới trong nhập khẩu, sản xuất, lắp ráp', 
        content: '''1. Đối tượng phải bảo đảm chất lượng an toàn kỹ thuật và bảo vệ môi trường bao gồm:
...
8. Bộ trưởng Bộ Quốc phòng, Bộ trưởng Bộ Công an quy định về trình tự, thủ tục chứng nhận chất lượng an toàn kỹ thuật và bảo vệ môi trường của xe cơ giới, xe máy chuyên dùng, phụ tùng xe cơ giới trong nhập khẩu, sản xuất, lắp ráp thuộc phạm vi quản lý của Bộ Quốc phòng, Bộ Công an.'''
      ...
      Article(
        title: 'Điều 42. Bảo đảm an toàn kỹ thuật và bảo vệ môi trường của xe cơ giới, xe máy chuyên dùng tham gia giao thông đường bộ', 
        content: '''1. Xe cơ giới, xe máy chuyên dùng tham gia giao thông đường bộ phải được kiểm định theo quy định của pháp luật.
...
6. Bộ trưởng Bộ Quốc phòng, Bộ trưởng Bộ Công an quy định về trình tự, thủ tục kiểm định an toàn kỹ thuật và bảo vệ môi trường của xe cơ giới, xe máy chuyên dùng, chứng nhận chất lượng an toàn kỹ thuật và bảo vệ môi trường của xe cơ giới cải tạo, xe máy chuyên dùng cải tạo thuộc phạm vi quản lý của Bộ Quốc phòng, Bộ Công an.'''
      ...
      Article(
        title: 'Điều 43. Trách nhiệm của cơ sở đăng kiểm, chủ xe cơ giới, xe máy chuyên dùng và người điều khiển xe cơ giới, xe máy chuyên dùng', 
        content: '''1. Cơ sở đăng kiểm là tổ chức cung cấp dịch vụ công thực hiện kiểm định an toàn kỹ thuật và bảo vệ môi trường đối với xe cơ giới, xe máy chuyên dùng được tổ chức, hoạt động theo quy định của Chính phủ.
...
đ) Chấp hành quy định khác của pháp luật khi tham gia giao thông đường bộ.'''
      ...
      Article(
        title: 'Điều 44. Bảo đảm trật tự, an toàn giao thông đường bộ đối với phương tiện vận tải đường bộ trong đô thị ', 
        content: '''1. Xe buýt, xe chở người bốn bánh có gắn động cơ phải hoạt động đúng tuyến, đúng lịch trình, thời gian được phép hoạt động và dừng xe, đỗ xe đúng nơi quy định.
...
5. Ủy ban nhân dân cấp tỉnh quy định về hoạt động vận tải đường bộ trong đô thị và tỷ lệ phương tiện vận chuyển hành khách công cộng có thiết bị hỗ trợ cho người khuyết tật trong đô thị.'''
      ...
      Article(
        title: 'Điều 45. Bảo đảm trật tự, an toàn giao thông đường bộ đối với xe ô tô vận chuyển hành khách', 
        content: '''1. Việc vận chuyển hành khách bằng xe ô tô phải tuân thủ các quy định sau đây:
...
g) Thực hiện các quy tắc giao thông đường bộ khác quy định tại Chương II của Luật này.'''
      ...
      Article(
        title: 'Điều 46. Bảo đảm trật tự, an toàn giao thông đường bộ đối với xe ô tô chở trẻ em mầm non, học sinh', 
        content: '''1. Xe ô tô kinh doanh vận tải chở trẻ em mầm non, học sinh phải đáp ứng các yêu cầu sau đây:
...
6. Xe đưa đón trẻ em mầm non, học sinh được ưu tiên trong tổ chức phân luồng, điều tiết giao thông, bố trí nơi dừng xe, đỗ xe tại khu vực trường học và tại các điểm trên lộ trình đưa đón trẻ em mầm non, học sinh.'''
      ...
      Article(
        title: 'Điều 47. Bảo đảm trật tự, an toàn giao thông đường bộ trong vận chuyển hành khách, hàng hóa bằng xe mô tô, xe gắn máy, xe thô sơ', 
        content: '''1. Việc sử dụng xe mô tô, xe gắn máy, xe thô sơ để vận chuyển hành khách, hàng hóa phải thực hiện các quy định sau đây:
...
2. Ủy ban nhân dân cấp tỉnh quy định về sử dụng xe mô tô, xe gắn máy, xe thô sơ để kinh doanh vận chuyển hành khách, hàng hóa tại địa phương.'''
      ...
      Article(
        title: 'Điều 48. Bảo đảm trật tự, an toàn giao thông đường bộ đối với xe bốn bánh có gắn động cơ vận chuyển hành khách, hàng hóa', 
        content: '''1. Xe bốn bánh có gắn động cơ vận chuyển hành khách, hàng hóa phải đáp ứng các yêu cầu sau đây:
...
2. Ủy ban nhân dân cấp tỉnh quy định thời gian, phạm vi hoạt động vận chuyển hành khách bằng xe bốn bánh có gắn động cơ và hoạt động vận chuyển hàng hóa bằng xe chở hàng bốn bánh có gắn động cơ tại địa phương.'''
      ...
      Article(
        title: 'Điều 49. Bảo đảm trật tự, an toàn giao thông đường bộ đối với xe ô tô vận chuyển hàng hóa ', 
        content: '''1. Khi vận chuyển hàng hóa bằng xe ô tô, người lái xe phải thực hiện các quy định sau đây:
...
2. Lực lượng Cảnh sát giao thông chịu trách nhiệm tổ chức tuần tra, kiểm soát, xử lý vi phạm pháp luật về trật tự, an toàn giao thông đường bộ đối với xe ô tô vận chuyển hàng hóa quá tải lưu hành trên đường bộ.'''
      ...
      Article(
        title: 'Điều 50. Bảo đảm trật tự, an toàn giao thông đường bộ đối với phương tiện giao thông đường bộ vận chuyển động vật sống, thực phẩm tươi sống', 
        content: '''1. Việc vận chuyển động vật sống phải bảo đảm các yêu cầu sau đây:
...
b) Trong quá trình vận chuyển phải chấp hành các quy định của pháp luật về trật tự, an toàn giao thông đường bộ, an toàn thực phẩm, vệ sinh dịch tễ, phòng dịch và bảo đảm vệ sinh môi trường.'''
      ...
      Article(
        title: 'Điều 51. Bảo đảm trật tự, an toàn giao thông đường bộ đối với phương tiện giao thông đường bộ vận chuyển hàng hóa nguy hiểm', 
        content: '''1. Hàng hóa nguy hiểm là hàng hóa có chứa các chất hoặc vật phẩm nguy hiểm khi chở trên đường bộ có khả năng gây nguy hại tới tính mạng, sức khỏe con người, môi trường, an toàn và an ninh quốc gia.
...
6. Chính phủ quy định chi tiết Điều này.'''
      ...
      Article(
        title: 'Điều 52. Bảo đảm trật tự, an toàn giao thông đường bộ đối với xe quá khổ giới hạn, xe quá tải trọng, xe bánh xích lưu hành trên đường bộ', 
        content: '''1. Xe quá khổ giới hạn bao gồm:
...
9. Bộ trưởng Bộ Giao thông vận tải quy định chi tiết điểm b khoản 3 Điều này; quy định về tải trọng, khổ giới hạn của đường bộ; quy định lưu hành xe quá khổ giới hạn, xe quá tải trọng, xe bánh xích trên đường bộ; quy định trình tự, thủ tục cấp giấy phép lưu hành cho xe quá tải trọng, xe quá khổ giới hạn, xe bánh xích.'''
      ...
      Article(
        title: 'Điều 53. Bảo đảm trật tự, an toàn giao thông đường bộ đối với xe vận chuyển hàng siêu trường, siêu trọng', 
        content: '''1. Hàng siêu trường, siêu trọng là hàng không thể chia nhỏ, tháo rời, khi vận chuyển trên đường bộ làm cho phương tiện hoặc tổ hợp phương tiện bị vượt quá giới hạn cho phép tham gia giao thông đường bộ về kích thước, khối lượng theo quy định của pháp luật.
...
7. Bộ trưởng Bộ Giao thông vận tải quy định cụ thể về hàng siêu trường, siêu trọng; quy định việc vận chuyển hàng siêu trường, siêu trọng và việc cấp giấy phép lưu hành xe vận chuyển hàng siêu trường, siêu trọng trên đường bộ.'''
      ...
      Article(
        title: 'Điều 54. Bảo đảm trật tự, an toàn giao thông đường bộ đối với xe cứu hộ giao thông đường bộ', 
        content: '''1. Xe cứu hộ giao thông đường bộ là xe ô tô chuyên dùng có trang bị dụng cụ, thiết bị dùng để cứu hộ, hỗ trợ di chuyển hoặc chuyên chở các phương tiện giao thông đường bộ bị hư hỏng, bị sự cố.
...
3. Xe cứu hộ giao thông đường bộ phải tuân thủ quy định của pháp luật về khối lượng hàng hóa chuyên chở của xe cứu hộ và khối lượng của xe được cứu hộ ghi trên Chứng nhận kiểm định an toàn kỹ thuật và bảo vệ môi trường.'''
      ...
      Article(
        title: 'Điều 55. Bảo đảm trật tự, an toàn giao thông đường bộ đối với trường hợp xe ô tô của người nước ngoài đăng ký tại nước ngoài có tay lái ở bên phải tham gia giao thông tại Việt Nam; xe cơ giới nước ngoài do người nước ngoài đưa vào Việt Nam du lịch', 
        content: '''1. Xe ô tô của người nước ngoài đăng ký tại nước ngoài có tay lái ở bên phải tham gia giao thông tại Việt Nam, xe cơ giới nước ngoài do người nước ngoài đưa vào Việt Nam du lịch phải được cơ quan có thẩm quyền cấp phép.
...
4. Chính phủ quy định chi tiết Điều này.'''
  ...
  Chapter(
    ...
    articles: [
      Article(
        title: 'Điều 56. Điều kiện của người điều khiển phương tiện tham gia giao thông đường bộ', 
        content: '''1. Người lái xe tham gia giao thông đường bộ phải đủ tuổi, sức khỏe theo quy định của pháp luật; có giấy phép lái xe đang còn điểm, còn hiệu lực phù hợp với loại xe đang điều khiển do cơ quan có thẩm quyền cấp, trừ người lái xe gắn máy quy định tại khoản 4 Điều này. Khi tham gia giao thông đường bộ, người lái xe phải mang theo các giấy tờ sau đây:
...
5. Người tập lái xe ô tô, người dự sát hạch lái xe ô tô khi tham gia giao thông đường bộ phải thực hành trên xe tập lái, xe sát hạch trên tuyến đường tập lái, tuyến đường sát hạch, có giáo viên dạy lái hoặc sát hạch viên bảo trợ tay lái. Giáo viên dạy lái, sát hạch viên phải mang theo các loại giấy tờ quy định tại khoản 1 Điều này.'''
      ...
      Article(
        title: 'Điều 57. Giấy phép lái xe', 
        content: '''1. Giấy phép lái xe bao gồm các hạng sau đây:tô tải và ô tô chuyên dùng có khối lượng toàn bộ theo thiết kế
...
đ) Hạng C1 cấp cho người lái xe ô Điều 71. Hệ thống giám sát bảo đảm an ninh, trật tự, an toàn giao thông đường bộ; hệ thống quản lý dữ liệu thiết bị giám sát hành trình và thiết bị ghi nhận hình ảnh người lái xe; hệ thống thiết bị kỹ thuật nghiệp vụ kiểm tra tải trọng xe cơ giớitrên 3.500 kg đến 7.500 kg; các loại xe ô tô tải quy định cho giấy phép lái xe hạng C1 kéo rơ moóc có khối lượng toàn bộ theo thiết kế đến 750 kg; các loại xe quy định cho giấy phép lái xe hạng B;
...
9. Bộ trưởng Bộ Giao thông vận tải quy định mẫu giấy phép lái xe và giấy phép lái xe quốc tế, trình tự, thủ tục cấp và việc sử dụng giấy phép lái xe, giấy phép lái xe quốc tế; đối với mẫu giấy phép lái xe, trình tự, thủ tục cấp và việc sử dụng giấy phép lái xe của lực lượng quân đội, công an làm nhiệm vụ quốc phòng, an ninh do Bộ trưởng Bộ Quốc phòng, Bộ trưởng Bộ Công an quy định.'''
      ...
      Article(
        title: 'Điều 58. Điểm của giấy phép lái xe ', 
        content: '''1. Điểm của giấy phép lái xe được dùng để quản lý việc chấp hành pháp luật về trật tự, an toàn giao thông đường bộ của người lái xe trên hệ thống cơ sở dữ liệu về trật tự, an toàn giao thông đường bộ, bao gồm 12 điểm. Số điểm trừ mỗi lần vi phạm tùy thuộc tính chất, mức độ của hành vi vi phạm pháp luật về trật tự, an toàn giao thông đường bộ. Dữ liệu về điểm trừ giấy phép lái xe của người vi phạm sẽ được cập nhật vào hệ thống cơ sở dữ liệu ngay sau khi quyết định xử phạt có hiệu lực thi hành và thông báo cho người bị trừ điểm giấy phép lái xe biết.
...
6. Chính phủ quy định chi tiết khoản 1 Điều này; quy định trình tự, thủ tục, thẩm quyền trừ điểm, phục hồi điểm giấy phép lái xe; quy định lộ trình thực hiện Điều này. Bộ trưởng Bộ Công an quy định chi tiết khoản 3 Điều này.'''
      ...
      Article(
        title: 'Điều 59. Tuổi, sức khỏe của người điều khiển phương tiện tham gia giao thông đường bộ', 
        content: '''1. Độ tuổi của người lái xe, người điều khiển xe máy chuyên dùng được quy định như sau:
...
3. Bộ trưởng Bộ Quốc phòng, Bộ trưởng Bộ Công an quy định độ tuổi của người lái xe trong lực lượng quân đội, công an làm nhiệm vụ quốc phòng, an ninh.'''
      ...
      Article(
        title: 'Điều 60. Đào tạo lái xe', 
        content: '''1. Người có nhu cầu được cấp giấy phép lái xe phải được đào tạo nội dung lý thuyết và thực hành theo chương trình đào tạo quy định cho từng hạng giấy phép lái xe.
...
8. Bộ trưởng Bộ Giao thông vận tải quy định hình thức, nội dung, chương trình đào tạo lái xe, thời gian lái xe an toàn cho từng hạng giấy phép lái xe quy định tại khoản 4 Điều này và quy định tiêu chuẩn của cơ sở đào tạo lái xe mô tô; đối với cơ sở đào tạo, tổ chức đào tạo lái xe cho lực lượng quân đội, công an làm nhiệm vụ quốc phòng, an ninh do Bộ trưởng Bộ Quốc phòng, Bộ trưởng Bộ Công an quy định.'''
      ...
      Article(
        title: 'Điều 61. Sát hạch lái xe', 
        content: '''1. Người đã hoàn thành chương trình đào tạo lái xe, có độ tuổi, sức khỏe theo quy định tại Điều 59 của Luật này được đăng ký để tham dự kỳ sát hạch lái xe.
...
7. Bộ trưởng Bộ Giao thông vận tải quy định hình thức, nội dung, quy trình sát hạch để cấp giấy phép lái xe; điều kiện, tiêu chuẩn sát hạch viên, tổ chức tập huấn, cấp thẻ sát hạch viên; tiêu chuẩn kỹ thuật sân tập lái để sát hạch lái xe mô tô, quy chuẩn kỹ thuật quốc gia về trung tâm sát hạch lái xe cơ giới đường bộ; đối với sát hạch lái xe cho lực lượng quân đội, công an làm nhiệm vụ quốc phòng, an ninh do Bộ trưởng Bộ Quốc phòng, Bộ trưởng Bộ Công an quy định.'''
      ...
      Article(
        title: 'Điều 62. Cấp, đổi, cấp lại và thu hồi giấy phép lái xe', 
        content: '''1. Giấy phép lái xe được cấp cho người tham dự kỳ sát hạch lái xe có kết quả đạt yêu cầu.
...
7. Bộ trưởng Bộ Quốc phòng, Bộ trưởng Bộ Công an quy định về cấp, đổi, cấp lại, thu hồi giấy phép lái xe cho lực lượng quân đội, công an làm nhiệm vụ quốc phòng, an ninh. Bộ trưởng Bộ Lao động Thương binh và Xã hội quy định điều kiện, trình tự, thủ tục cấp, đổi, cấp lại, thu hồi chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có giấy phép lái xe quy định tại các điểm d, e, g, h, i, k, l, m và n khoản 3 Điều 89 của Luật này.'''
      ...
      Article(
        title: 'Điều 63. Đào tạo, kiểm tra cấp chứng chỉ bồi dưỡng kiến thức pháp luật về giao thông đường bộ cho người điều khiển xe máy chuyên dùng', 
        content: '''1. Chứng chỉ bồi dưỡng kiến thức pháp luật về giao thông đường bộ là giấy chứng nhận cấp cho người có đủ điều kiện theo quy định của pháp luật để điều khiển xe máy chuyên dùng tham gia giao thông đường bộ.
...
5. Bộ trưởng Bộ Quốc phòng, Bộ trưởng Bộ Công an quy định hình thức, nội dung, chương trình bồi dưỡng kiến thức pháp luật về giao thông đường bộ; tiêu chuẩn của cơ sở đào tạo người điều khiển xe máy chuyên dùng thực hiện bồi dưỡng, kiểm tra, cấp chứng chỉ bồi dưỡng kiến thức pháp luật về giao thông đường bộ cho lực lượng quân đội, công an làm nhiệm vụ quốc phòng, an ninh.'''
      ...
      Article(
        title: 'Điều 64. Thời gian làm việc của người lái xe ô tô kinh doanh vận tải và vận tải nội bộ', 
        content: '''1. Thời gian lái xe của người lái xe ô tô không quá 10 giờ trong một ngày và không quá 48 giờ trong một tuần; lái xe liên tục không quá 04 giờ và bảo đảm các quy định có liên quan của Bộ luật Lao động.
...
2. Đơn vị kinh doanh vận tải, đơn vị hoạt động vận tải nội bộ và người lái xe ô tô kinh doanh vận tải và vận tải nội bộ chịu trách nhiệm thực hiện các quy định tại Điều này.'''
  ...
  Chapter(
    ...
    articles: [
      Article(
        title: 'Điều 65. Hoạt động tuần tra, kiểm soát về trật tự, an toàn giao thông đường bộ', 
        content: '''1. Hoạt động tuần tra, kiểm soát bao gồm:
...
8. Xe cơ giới quân sự, xe máy chuyên dùng quân sự và người điều khiển xe cơ giới quân sự, xe máy chuyên dùng quân sự tham gia giao thông đường bộ phải chấp hành yêu cầu kiểm tra, kiểm soát về trật tự, an toàn giao thông đường bộ của Cảnh sát giao thông và yêu cầu kiểm tra về điều lệnh nội vụ, kiểm tra việc chấp hành pháp luật của lực lượng kiểm soát quân sự, kiểm tra xe quân sự. Hoạt động kiểm tra điều lệnh nội vụ và việc chấp hành pháp luật của lực lượng kiểm soát quân sự, kiểm tra xe quân sự trên đường bộ thực hiện theo quy định của Bộ trưởng Bộ Quốc phòng.'''
      ...
      Article(
        title: 'Điều 66. Căn cứ dừng phương tiện tham gia giao thông đường bộ để kiểm tra, kiểm soát', 
        content: '''Cảnh sát giao thông được dừng phương tiện tham gia giao thông đường bộ để kiểm tra, kiểm soát khi có một trong các căn cứ sau đây:
...
4. Có tin báo, tố giác, phản ánh, kiến nghị, đề nghị của cơ quan, tổ chức, cá nhân về tội phạm, hành vi vi phạm pháp luật khác.'''
      ...
      Article(
        title: 'Điều 67. Biện pháp phát hiện vi phạm pháp luật về trật tự, an toàn giao thông đường bộ ', 
        content: '''1. Vận hành, sử dụng hệ thống giám sát bảo đảm an ninh, trật tự, an toàn giao thông đường bộ; hệ thống camera trên tuyến giao thông, trong đô thị; công trình, hệ thống thiết bị kỹ thuật nghiệp vụ kiểm tra, kiểm soát tải trọng xe cơ giới.
...
7. Biện pháp khác theo quy định của pháp luật.'''
      ...
      Article(
        title: 'Điều 68. Huy động người, phương tiện, thiết bị dân sự trong trường hợp cấp bách ', 
        content: '''1. Khi thực hiện nhiệm vụ tuần tra, kiểm soát, chỉ huy, điều khiển giao thông đường bộ, giải quyết tai nạn giao thông đường bộ, trong trường hợp cấp bách để bảo vệ an ninh quốc gia, bảo đảm trật tự, an toàn xã hội hoặc để ngăn chặn hậu quả thiệt hại cho xã hội đang xảy ra hoặc có nguy cơ xảy ra, người chỉ huy trực tiếp của Cảnh sát giao thông tại hiện trường được huy động người, phương tiện, thiết bị dân sự và người đang sử dụng, điều khiển phương tiện, thiết bị đó.
...
4. Trong quá trình thực hiện việc di chuyển phương tiện theo quy định tại khoản 1 Điều này, Cảnh sát giao thông, tổ chức, cá nhân được thuê thực hiện việc di chuyển phương tiện phải có trách nhiệm bảo đảm an toàn cho phương tiện được di chuyển.'''
      ...
      Article(
        title: 'Điều 70. Trang bị, sử dụng phương tiện, thiết bị, vũ khí, công cụ hỗ trợ khi tuần tra, kiểm soát', 
        content: '''1. Lực lượng Cảnh sát giao thông được trang bị vũ khí, công cụ hỗ trợ theo quy định của pháp luật về quản lý, sử dụng vũ khí, vật liệu nổ và công cụ hỗ trợ; phương tiện giao thông đường bộ, phương tiện, thiết bị kỹ thuật nghiệp vụ, thiết bị thông minh hỗ trợ chỉ huy, điều khiển giao thông đường bộ. Lực lượng khác trong Công an nhân dân tham gia phối hợp với Cảnh sát giao thông thực hiện tuần tra, kiểm soát được trang bị phương tiện, thiết bị kỹ thuật nghiệp vụ, vũ khí, công cụ hỗ trợ phù hợp với nhiệm vụ được giao theo quy định của pháp luật.
...
3. Vũ khí, công cụ hỗ trợ trang bị được quản lý theo quy định của pháp luật về quản lý, sử dụng vũ khí, vật liệu nổ và công cụ hỗ trợ; phương tiện, thiết bị kỹ thuật nghiệp vụ, thiết bị thông minh hỗ trợ chỉ huy, điều khiển giao thông đường bộ được quản lý theo quy định của Luật này, pháp luật về xử lý vi phạm hành chính và các quy định khác của pháp luật có liên quan.'''
      ...
      Article(
        title: 'Điều 71. Hệ thống giám sát bảo đảm an ninh, trật tự, an toàn giao thông đường bộ; hệ thống quản lý dữ liệu thiết bị giám sát hành trình và thiết bị ghi nhận hình ảnh người lái xe; hệ thống thiết bị kỹ thuật nghiệp vụ kiểm tra tải trọng xe cơ giới', 
        content: '''1. Hệ thống giám sát bảo đảm an ninh, trật tự, an toàn giao thông đường bộ được quy định như sau:
...
4. Bộ trưởng Bộ Công an ban hành quy chuẩn kỹ thuật quốc gia về hệ thống giám sát bảo đảm an ninh, trật tự, an toàn giao thông đường bộ và quy chuẩn kỹ thuật quốc gia về thiết bị giám sát hành trình và thiết bị ghi nhận hình ảnh người lái xe; quy định việc xây dựng, quản lý, vận hành, khai thác và sử dụng hệ thống giám sát bảo đảm an ninh, trật tự, an toàn giao thông đường bộ, thiết bị thông minh hỗ trợ chỉ huy, điều khiển giao thông đường bộ; quy định việc quản lý, vận hành, sử dụng hệ thống quản lý dữ liệu thiết bị giám sát hành trình và thiết bị ghi nhận hình ảnh người lái xe; quy định việc trang bị, lắp đặt, quản lý, vận hành, sử dụng hệ thống thiết bị kỹ thuật nghiệp vụ kiểm tra tải trọng xe cơ giới.'''
      ...
      Article(
        title: 'Điều 72. Quyền và trách nhiệm của người điều khiển phương tiện tham gia giao thông đường bộ', 
        content: '''1. Người điều khiển phương tiện tham gia giao thông đường bộ có quyền sau đây:
...
c) Hỗ trợ, hợp tác với lực lượng bảo đảm trật tự, an toàn giao thông đường bộ trong quá trình phát hiện, ngăn chặn và xử lý vi phạm pháp luật về trật tự, an toàn giao thông đường bộ và vi phạm pháp luật khác.'''
      ...
      Article(
        title: 'Điều 73. Ngăn chặn hành vi không chấp hành yêu cầu kiểm tra, kiểm soát, cản trở, chống người thi hành công vụ', 
        content: '''1. Khi người tham gia giao thông đường bộ không chấp hành yêu cầu kiểm tra, kiểm soát, có hành vi cản trở, chống người thi hành công vụ thì người thi hành công vụ thực hiện các biện pháp sau đây:
...
2. Trường hợp người điều khiển phương tiện tham gia giao thông đường bộ không chấp hành tín hiệu, hiệu lệnh dừng phương tiện và bỏ chạy thì người thi hành công vụ được thực hiện quyền truy đuổi để ngăn chặn và xử lý hành vi vi phạm.'''
  ...
  Chapter(
    ...
    articles: [
      Article(
        title: 'Điều 74. Chỉ huy, điều khiển giao thông đường bộ', 
        content: '''1. Chỉ huy giao thông đường bộ là tổng hợp các hoạt động thu thập, phân tích, đánh giá các yếu tố có liên quan để đưa ra các giải pháp điều hành hoạt động giao thông đường bộ trật tự, an toàn, thông suốt, được thực hiện thông qua người có thẩm quyền chỉ huy giao thông; trung tâm chỉ huy giao thông; thiết bị thông minh hỗ trợ chỉ huy, điều khiển giao thông đường bộ.
...
3. Bộ trưởng Bộ Công an quy định chi tiết Điều này.'''
      ...
      Article(
        title: 'Điều 75. Trung tâm chỉ huy giao thông', 
        content: '''1. Trung tâm chỉ huy giao thông bao gồm các công trình hạ tầng kỹ thuật, hệ thống thiết bị công nghệ và cơ sở dữ liệu do lực lượng Cảnh sát giao thông quản lý, vận hành, khai thác.
...
5. Bộ trưởng Bộ Công an ban hành quy chuẩn kỹ thuật quốc gia về trung tâm chỉ huy giao thông; quy định việc xây dựng, quản lý, hoạt động của trung tâm chỉ huy giao thông.'''
      ...
      Article(
        title: 'Điều 76. Giải quyết tình huống đột xuất gây mất trật tự, an toàn giao thông trên đường bộ', 
        content: '''1. Tình huống đột xuất gây mất trật tự, an toàn giao thông trên đường bộ bao gồm: ùn tắc giao thông; tai nạn giao thông đường bộ; hư hỏng kết cấu hạ tầng giao thông đường bộ; thiên tai, cháy, nổ gây mất an toàn giao thông đường bộ; tình huống phức tạp về an ninh, trật tự trên đường bộ.
...
4. Chính phủ quy định chi tiết Điều này.'''
      ...
      Article(
        title: 'Điều 78. Giải quyết, khắc phục ùn tắc giao thông', 
        content: '''1. Khi xảy ra tình huống đột xuất ùn tắc giao thông, Cảnh sát giao thông phải tiến hành các biện pháp giải quyết theo quy định tại khoản 3 Điều 76 của Luật này.
...
c) Cơ quan, tổ chức, cá nhân có liên quan có trách nhiệm phối hợp với cơ quan Cảnh sát giao thông, cơ quan quản lý đường bộ thực hiện các biện pháp phòng ngừa, giải quyết, khắc phục ùn tắc giao thông. '''
      ...
      Article(
        title: 'Điều 79. Kiến nghị về trật tự, an toàn giao thông đường bộ đối với công trình đường bộ', 
        content: '''1. Khi tiếp nhận thông tin về nguy cơ hư hỏng kết cấu hạ tầng giao thông đường bộ theo quy định tại khoản 1 Điều 76 của Luật này hoặc trực tiếp phát hiện nguy cơ mất an toàn đối với công trình đường bộ, các bất hợp lý về tổ chức giao thông, cơ quan Cảnh sát giao thông có trách nhiệm sau đây:
...
b) Chịu trách nhiệm nếu để xảy ra hậu quả do không xử lý, khắc phục các yếu tố gây mất an toàn giao thông đường bộ theo quy định tại điểm a khoản này.'''
  ...
  Chapter(
    ...
    articles: [
      Article(
        title: 'Điều 80. Trách nhiệm của người điều khiển phương tiện tham gia giao thông đường bộ gây ra tai nạn giao thông đường bộ, người liên quan và người có mặt tại hiện trường vụ tai nạn giao thông đường bộ', 
        content: '''1. Người điều khiển phương tiện tham gia giao thông đường bộ gây ra tai nạn giao thông đường bộ, người liên quan đến vụ tai nạn giao thông đường bộ có trách nhiệm sau đây:
...
4. Người điều khiển phương tiện tham gia giao thông đường bộ khác khi đi qua nơi xảy ra vụ tai nạn giao thông đường bộ có trách nhiệm chở người bị thương đi cấp cứu. Xe ưu tiên, xe chở người được hưởng quyền ưu đãi, miễn trừ ngoại giao không bắt buộc thực hiện quy định tại khoản này.'''
      ...
      Article(
        title: 'Điều 81. Phát hiện, tiếp nhận, xử lý tin báo tai nạn giao thông đường bộ', 
        content: '''1. Cơ quan, tổ chức, cá nhân khi phát hiện vụ tai nạn giao thông đường bộ phải báo ngay cho cơ quan Công an, cơ sở khám bệnh, chữa bệnh hoặc Ủy ban nhân dân nơi gần nhất.
...
5. Trường hợp tai nạn giao thông đường bộ liên quan đến phương tiện giao thông đường bộ chở hàng hóa nguy hiểm, cơ quan Công an chủ trì giải quyết vụ việc phải thông báo ngay cho đơn vị chức năng về giải quyết hóa chất độc hại, vật liệu cháy, nổ; phong tỏa hiện trường nơi xảy ra tai nạn giao thông đường bộ; tổ chức phân luồng giao thông, cấm người, phương tiện đi vào khu vực tai nạn.'''
      ...
      Article(
        title: 'Điều 83. Điều tra, giải quyết tai nạn giao thông đường bộ ', 
        content: '''1. Nguyên tắc điều tra, giải quyết tai nạn giao thông đường bộ được quy định như sau:
...
4. Bộ trưởng Bộ Công an quy định quy trình điều tra, giải quyết tai nạn giao thông đường bộ của Cảnh sát giao thông.'''
      ...
      Article(
        title: 'Điều 84. Thống kê tai nạn giao thông đường bộ', 
        content: '''1. Thông tin về tai nạn giao thông đường bộ phải được thống kê chính xác, đầy đủ, kịp thời; kết quả thống kê, tổng hợp về tai nạn giao thông đường bộ phục vụ nghiên cứu, đề ra các giải pháp phòng ngừa tai nạn giao thông đường bộ.
...
5. Bộ trưởng Bộ Công an quy định chi tiết Điều này.'''
      ...
      Article(
        title: 'Điều 85. Quỹ giảm thiểu thiệt hại tai nạn giao thông đường bộ', 
        content: '''1. Quỹ giảm thiểu thiệt hại tai nạn giao thông đường bộ là quỹ tài chính nhà nước ngoài ngân sách, được hình thành ở trung ương để huy động nguồn lực xã hội hỗ trợ giảm thiểu thiệt hại tai nạn giao thông đường bộ.
...
5. Chính phủ quy định chi tiết khoản 2 và khoản 3 Điều này; quy định việc thành lập, quản lý, sử dụng Quỹ giảm thiểu thiệt hại tai nạn giao thông đường bộ.'''
  ...
  Chapter(
    ...
    articles: [
      Article(
        title: 'Điều 86. Nội dung quản lý nhà nước về trật tự, an toàn giao thông đường bộ', 
        content: '''1. Xây dựng, ban hành và tổ chức thực hiện chính sách, chiến lược, chương trình, kế hoạch, đề án, dự án về trật tự, an toàn giao thông đường bộ.
...
13. Hợp tác quốc tế về trật tự, an toàn giao thông đường bộ.'''
      ...
      Article(
        title: 'Điều 87. Trách nhiệm quản lý nhà nước về trật tự, an toàn giao thông đường bộ', 
        content: '''1. Chính phủ thống nhất quản lý nhà nước về trật tự, an toàn giao thông đường bộ.
...
8. Ủy ban nhân dân các cấp, trong phạm vi nhiệm vụ, quyền hạn của mình, thực hiện quản lý nhà nước về trật tự, an toàn giao thông đường bộ tại địa phương.'''
  ...
  Chapter(
    ...
    articles: [
      Article(
        title: 'Điều 88. Hiệu lực thi hành', 
        content: '''1. Luật này có hiệu lực thi hành từ ngày 01 tháng 01 năm 2025, trừ trường hợp quy định tại khoản 2 Điều này.
...
4. Nghị quyết số 73/2022/QH15 của Quốc hội về thí điểm đấu giá biển số xe ô tô hết hiệu lực kể từ ngày Luật này có hiệu lực thi hành, trừ trường hợp quy định tại khoản 7 Điều 89 của Luật này.'''
      ...
      Article(
        title: 'Điều 89. Quy định chuyển tiếp', 
        content: '''1. Giấy phép lái xe được cấp trước ngày Luật này có hiệu lực thi hành được tiếp tục sử dụng theo thời hạn ghi trên giấy phép lái xe.
